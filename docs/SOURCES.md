...
|---|---|
| [The Book](https://doc.rust-lang.org/stable/book/title-page.html) | The spine. Units 00 to 24 follow its arc and go past it: it introduces ownership in one chapter, this takes three (05, 06, 07) and attaches every rule to the bug it prevents. |
